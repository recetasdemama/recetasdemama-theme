 ...
 * Widget: Siguenos
 */
include 'includes/siguenos.php';

/*
 * Widget: Categorias populares
 */
include 'includes/cat-populares.php';
...
function new_excerpt_more($more) {
	...
	$moreLink = '<a class="more-link" href="'. get_permalink($post->ID) . '">LEER MÁS</a>';
...
function toolbox_widgets_init() {
	...
	//DR
	register_sidebar( array(
		'name' => __( 'Banner Entre Post', 'toolbox' ),
		'id' => 'posts-ad-banner',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget' => "</aside>",
		'before_title' => '<h1 class="widget-title">',
	...
	register_sidebar( array(
		'name' => __( 'Sidebar Comentarios', 'toolbox' ),
		'id' => 'sidebar-coments',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget' => "</aside>",
		'before_title' => '<h1 class="widget-title">',
